...
namespace GestionCourse.Controllers
{
    public class UniteDistancesController : Controller
    {
        private ContextGestionCourse db = new ContextGestionCourse();

        // GET: UniteDistances
        public ActionResult Index()
        {
            return View(db.UniteDistance.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            UniteDistance uniteDistance = db.UniteDistance.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,unite")] UniteDistance uniteDistance)
        {
            ...
            {
                db.UniteDistance.Add(uniteDistance);
                db.SaveChanges();
        ...
        {
            UniteDistance uniteDistance = db.UniteDistance.Find(id);
            db.UniteDistance.Remove(uniteDistance);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
